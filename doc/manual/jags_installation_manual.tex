...
\subsection{Configuration for a 64-bit build}
...
\JAGS, if you are using GNU compiler. MKL can be used if \JAGS\ is
configured with the option \verb+--disable-shared+., This builds an
executable that is statically linked to the \JAGS\ library and
modules.
...
On Windows Vista or Windows 7, your MSYS home directory will be your
Windows home directory. On earlier versions of Windows, 
