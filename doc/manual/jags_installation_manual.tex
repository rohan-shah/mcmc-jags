...
and not relative to the JAGS build directory. The flag
\code{-D\_GLIBCXX\_USE\_CXX11\_ABI=0} ensures compatibility with the
Windows binary distribution of R from CRAN.
