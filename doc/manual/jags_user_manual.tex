...
inits in "line-inits.R"  # Read initial values from file
...
\verb+acos(x)+      & Arc-cosine            & Real & $-1 < x < 1$\\
\verb+acosh(x)+     & Hyperbolic arc-cosine & Real & $1 < x$ \\
\verb+asin(x)+      & Arc-sine              & Real & $-1 < x < 1$\\
\verb+asinh(x)+     & Hyperbolic arc-sine   & Real &\\
\verb+atan(x)+      & Arc-tangent           & Real &\\
\verb+atanh(x)+     & Hyperbolic arc-tangent & Real & $-1 < x < 1$\\
