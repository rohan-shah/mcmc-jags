...
static bool anyChildInSet(Sampler const *sampler, set<StochasticNode const*> const &sset)
{
    vector<StochasticNode const*> const &schildren = sampler->stochasticChildren();
