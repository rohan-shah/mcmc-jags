#ifndef ALBERT_CHIB_GIBBS_H_
#define ALBERT_CHIB_GIBBS_H_
...
namespace glm {
     ...
     */
    class AlbertChibGibbs : public GLMGibbs {
    public:
	/**
	 * Constructor.
	 * 
	 ...
	 */
	AlbertChibGibbs(GraphView const *view, 
			std::vector<SingletonGraphView const *> const &subviews,
