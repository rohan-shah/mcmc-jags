...
void ConjugateLM::calBeta(cs *beta, LMSampler *sampler, unsigned int chain) 
const
{
	...
	throw logic_error("Dimension mismatch in ConjugateLM::calBeta");
    }
