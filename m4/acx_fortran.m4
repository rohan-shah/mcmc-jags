# After parts of fortran.m4 from autoconf 2.59 
# hacked up by Bill Northcott <w.northcott@unsw.edu.au>
# Should not be required with next release of autoconf.
#
...
# "ACX_F77_LIBRARY_LDFLAGS" was created to determine these Fortran
# libraries.
#
...
AC_DEFUN([_ACX_FC_LIBRARY_LDFLAGS],
...
# ----------------------
AC_DEFUN([ACX_F77_LIBRARY_LDFLAGS],
...
# ACX_FC_LIBRARY_LDFLAGS
# ----------------------
AC_DEFUN([ACX_FC_LIBRARY_LDFLAGS],
...
# _ACX_F77_NAME_MANGLING
# ----------------------
AC_DEFUN([_ACX_F77_NAME_MANGLING],
[AC_REQUIRE([ACX_F77_LIBRARY_LDFLAGS])dnl
...
# _ACX_FC_NAME_MANGLING
# ----------------------
AC_DEFUN([_ACX_FC_NAME_MANGLING],
[AC_REQUIRE([ACX_FC_LIBRARY_LDFLAGS])dnl
...
# ACX_F77_WRAPPERS
# ---------------
AC_DEFUN([ACX_F77_WRAPPERS],
[AC_REQUIRE([_ACX_F77_NAME_MANGLING])dnl
AC_LANG_PUSH(Fortran 77)dnl
_AC_FC_WRAPPERS
AC_LANG_POP(Fortran 77)dnl
])# ACX_F77_WRAPPERS
...
# ACX_FC_WRAPPERS
# --------------
AC_DEFUN([ACX_FC_WRAPPERS],
[AC_REQUIRE([_ACX_FC_NAME_MANGLING])dnl
AC_LANG_PUSH(Fortran)dnl
_AC_FC_WRAPPERS
AC_LANG_POP(Fortran)dnl
])# ACX_FC_WRAPPERS
