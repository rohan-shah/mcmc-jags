dnl Adapted from AX_LAPACK 03 Feb 2007.
dnl Check for dgeev not cheev. JAGS only uses the double precision
dnl LAPACK functions, and the Intel Math Kernel library puts these
dnl in a separate dynamic library.
dnl --------------------------------------------------------------
